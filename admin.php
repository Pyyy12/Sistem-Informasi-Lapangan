...
<!-- Jumbotron -->
  ...
  <div class="container">
    <a class="navbar-brand text-white fw-bold glowing-text" href="user.php"><strong>Arena</strong> Ku</a>
    ...
    <div class="col-md-6 d-flex justify-content-end">
      <div class="card bg-dark text-white border-light">
        ...
        <div class="card-img-overlay d-flex align-items-center justify-content-center">
          <a href="daftar_menu.php" class="btn btn-primary">LIHAT DAFTAR LAPANGAN</a>
        </div>
      </div>
    </div>
  ...
  <!-- Awal Footer -->
      ...
      <div class="container">
        <div class="row footer-body">
          <div class="col-md-6">
          <div class="copyright">
            <strong>Copyright</strong> <i class="far fa-copyright"></i> 2025 -  Designed by Admin</p>
          </div>
          </div>
